 ...
 * Last updated: 2026-02-04T15:32:04Z
 */

const CONFERENCES_DATA = {
	"lastUpdated": "2026-02-04T15:32:04Z",
	"conferences": [
			{
				"id": "aaai-2027",
				"name": "AAAI",
			...
			},
			{
				...
				"deadlines": [
					{
						"type": "paper",
						"label": "Submission deadline (all papers are submitted to ARR)",
			...
			},
			{
				...
				"deskRejectReasons": [
					...
					"Submission does not meet the required criteria"
				],
				"notes": []
			},
			{
			...
			},
			{
				...
				"info": {
					"pageLimit": "9 pages + unlimited references",
					"reviewType": "Double-blind",
					"submissionFormat": "PDF"
				},
				"deskRejectReasons": [
					...
					"Authors on 3+ papers failing to review 6+ papers",
					"No authors registered as a reviewer",
			...
			},
			{
				...
				"info": {
					"pageLimit": "6 pages + up to two extra pages ($205 USD charge per extra page)",
