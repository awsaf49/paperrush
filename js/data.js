 ...
 * Last updated: 2026-04-20T09:04:00Z
 */

const CONFERENCES_DATA = {
	"lastUpdated": "2026-04-20T09:04:00Z",
	"conferences": [
			{
				"id": "aaai-2027",
				"name": "AAAI",
				...
				"info": {
					...
					"submissionSitePlatform": "OpenReview",
					"authorSubmissionLimit": 10,
					"submissionsMainTechnicalTrackReceived": 29000,
					"submissionsUnderReview": 23000,
					"reviewersRecruited": "28000+",
					"uniqueSubmittingAuthors": "75000+",
					"aiAssistedReviewingExperiment": "promising early results"
				},
				"notes": [],
				"isEstimated": true
			},
			...
			},
			{
				...
				"info": {
					"pageLimit": "8 pages + unlimited references",
					"reviewType": "Double-blind",
					"conferenceFullName": "The IEEE/CVF Conference on Computer Vision and Pattern Recognition 2026",
					"findingsTrackIntroduced": "CVPR 2026 introduces a new Findings Track",
					"externalLinksProhibited": "Authors are not allowed to include external links",
					"promptInjectionProhibited": "Prompt injection is strictly prohibited",
					...
					"publicationAndPatentDisclosure": "All accepted papers will be publicly released by the Computer Vision Foundation (CVF) two weeks before the conference."
				},
				"deskRejectReasons": [
					"Security incident information misuse",
					"Harassment, retaliation, or leaked info use",
					"Anonymity violation",
					"Wrong template",
					"Page limit exceeded",
					...
					"Author order changes after paper deadline",
					"Incomplete OpenReview profile by abstract deadline",
					"Dual submission violation",
					"Exceeding 25 paper submission limit",
					"Incomplete author registration",
					"Media embargo violation",
					...
					"New submission after abstract deadline",
					"Add/delete authors after abstract deadline",
					"External links expanding content",
					"External links subverting review process",
					"External links violating anonymity",
					"External links breaching media ban",
					"External links bypassing length/deadline restrictions",
					"Media discussion before acceptance",
					"Post online with 'submitted to CVPR' note",
			...
			},
			{
				...
				"links": {
					...
					"submission": "https://eccv.ecva.net/Conferences/2026/CompleteYourORProfile",
				...
				"info": {
					...
					"datasetReleasePolicy": "Datasets/Benchmarks must be publicly available by camera-ready deadline.",
					"codeReleasePolicy": "Code must be released by camera-ready deadline if promised.",
					"primaryContributionTypes": [
						"Algorithms / General",
						"Theory / Foundational",
						"Applied / Systems",
						"Datasets / Benchmarks",
					...
					"dataEthicsConsiderations": [
						"Potential for bias against protected characteristics",
						"Human subject experimentation review and approval",
						"Use of discredited datasets (e.g., DukeMTMC-ReID)",
						"Consent to use or share data",
						"Domain specific considerations for high-risk groups",
						"Filtering of offensive content in datasets",
						"Compliance with GDPR and other data regulations"
					],
					"springerNatureEthicsPolicies": [
						"Ethics and Informed Consent: Studies with human/animal participants require ethics committee approval and informed consent.",
						"Figures and Illustrations: Observe copyright, personality, and trademark rights for images; secure permissions/consent."
					],
					"plagiarismCheckTool": "iThenticate",
					"inPersonPresentationRequired": true,
					"publicDisclosurePolicy": "Accepted papers made public 4 weeks before conference or when authors make it public, whichever is first.",
				...
				"deskRejectReasons": [
					...
					"External links in submission",
					"Failure to provide stable dataset URL by camera-ready deadline",
					"Dataset/Benchmark URL not provided by camera-ready deadline",
					"Failure to provide public dataset URL by camera-ready",
					"Claiming private dataset as contribution",
					"Data use exacerbating bias",
					"Human subject experimentation unapproved",
					"Use of discredited datasets",
					"Lack of data consent",
					"No safeguards for high-risk groups",
					"No filtering of offensive content in data",
					"Non-compliance with data regulations",
					"No ethics committee approval for studies",
					"No informed consent for participants/data",
					"Image copyright or rights violation",
					"Late submissions",
					"Submissions via email",
					"Requests to modify authors",
			...
			},
			{
				...
				"deadlines": [
					...
					},
					{
						"type": "camera",
						"label": "Camera-Ready Deadline",
						"date": "2026-09-20T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					}
			...
			},
			{
				...
				"info": {
					...
					"lecturePresentationTime": "20 minutes total, 16 minutes for slides"
				},
				"notes": []
			},
			{
				...
				"deadlines": [
					...
					{
						"type": "paper",
						"label": "Short Course Proposal Submission",
						"date": "2025-12-31T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "paper",
						"label": "Satellite Workshop Proposal Submission",
				...
				"links": {
					...
					"submission": "https://2026.ieeeicip.org/publishing-presentation-options/",
				...
				"info": {
					...
					"conferenceName": "2026 IEEE International Conference on Image Processing",
					"conferenceSeriesEdition": "33rd edition",
					"presentationOptions": "Option to present a demo at the Show & Tell session",
					"publicationInfo": "Published in IEEE Xplore as part of ICIP 2026 Proceedings",
					"topPapersRecognition": "Spotlighted at the conference and awarded expedite review for journal extensions",
					"ieeeXploreOpenPreviewPeriod": "August 13th through September 13th",
					"anonymizationRules": "Authors must adhere to anonymization rules during manuscript submission.",
					"publicationVenue": "IEEE Open Journal of Signal Processing (OJSP)",
					"publicationNote": "Accepted papers are published as Open Access articles in OJSP, not in the ICIP conference proceedings.",
					"articleProcessingChargeFull": "$2,160",
					"articleProcessingChargeDiscounted": "$1,500",
					"registrationCoversPapers": "up to four accepted papers"
				},
				"deskRejectReasons": [
					"No-show policy violation",
					"Late paper submission",
					"Incorrect figures",
					"Missing acknowledgements",
					"Manuscript entirely LLM-generated",
					"Unverified LLM-generated code",
					"Unverified LLM-generated text",
					"Anonymity violation",
					"Not presented at conference",
					"Proxy presentation without permission",
					"Failure to disclose conflicts of interest",
					"Failure to report ethical compliance"
				],
				"notes": []
			},
			{
				...
				"deadlines": [
					...
					{
						"type": "art",
						"label": "Reviewer/AC Private Discussion Starts",
					...
					{
						"type": "event",
						"label": "Reviewer/AC Private Discussion Ends",
						"date": "2026-01-22T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "workshop",
						"label": "Workshop Schedule Finalized Deadline",
					...
					{
						"type": "workshop",
						"label": "Workshop Complimentary Registration Deadline",
				...
				"info": {
					"pageLimit": "9 pages + unlimited references; unlimited appendices (reviewers not required to read); optional ethics statement (max 1 page, not counted); optional reproducibility statement (not counted); 10 pages for camera ready/rebuttal",
					"reviewType": "Double-blind",
					"submissionFormat": "PDF",
					"conferenceFullName": "The Fourteenth International Conference on Learning Representations",
					"supplementaryMaterialGuidance": "single file (paper + supplementary text) after references, clearly marked; source code encouraged for replicability",
					"conferencePosterMaxSizeLandscape": "1.90m x 0.90m (76.4in x 37.4in) width/height",
					"workshopPosterMaxSizePortrait": "61cm x 91cm (24in x 36in) width/height",
					"posterTapeProvided": true,
					"posterTopicRequired": true,
					"posterUploadRecommended": true,
					"slideDeckRecommendedForOral": true,
					"videoRecordingHighlyRecommended": true
				},
				"deskRejectReasons": [
					"Anonymity violation",
					"Page limit exceeded",
					"Placeholder or duplicate abstracts",
					"Failure to finish assigned reviews",
					"No author registered as reviewer",
					"Not disclosing significant LLM usage",
					"Paper uploaded after deadline",
					"Wrong version uploaded after deadline",
					"Not all authors have OpenReview account by full paper deadline",
					"OpenReview account not created by full paper deadline",
					"Adding or removing authors after abstract deadline",
					"Placeholder abstract submission",
					"Anonymous link tracks visitors",
					"Major title/abstract changes from original submission"
				],
				"notes": []
			},
			{
				...
				"deadlines": [
					...
					{
						"type": "notification",
						"label": "Initial Author Notification",
					...
					{
						"type": "notification",
						"label": "Final Author Notification",
				...
				"info": {
					"pageLimit": "8 pages + unlimited references and appendices; 9 pages for camera-ready",
					"reviewType": "Double-blind",
					"submissionFormat": "PDF",
					"expoTutorialDay": "July 6, 2026",
					"mainConferenceDates": "July 7–9, 2026",
					"workshopsDates": "July 10–11, 2026",
					"reproducibilityPolicy": "Code submission encouraged; reproducibility taken into account.",
					"supplementaryMaterialTypes": "supplementary manuscripts, code, data",
					"cameraReadySupplementaryMaterialPolicy": "No supplementary material for final camera-ready version in proceedings.",
					"authorAttendanceOptional": true,
					"originalVersionPublished": true,
					"llmPolicyInReviewing": true,
				...
				"deskRejectReasons": [
					...
					"Non-anonymized or shortened URLs in author response",
					"Page limit exceeded",
					"Incorrect submission format",
					"Incorrect style files",
					"Placeholder abstracts substantially rewritten",
					"Author list changes without approval",
					"Not meeting per-submission reviewer requirement",
					"Authors not meeting per-author reviewer requirement",
					"Reviewers failing to participate adequately",
					...
					"Collusion",
					"Ethical grounds (by program chairs)",
			...
			},
			{
				...
				"deadlines": [
					...
					{
						"type": "notification",
						"label": "Special Session, Competition, and Forum Notification",
				...
				"info": {
					...
					"submissionFormat": "PDF",
					"videoSupplementLimit": "1-minute video (up to 10 MB)",
					"videoFormats": "MPG, MPEG or MP4",
					"resubmissionCategory": "ICRA-IROS transfer"
				},
				"deskRejectReasons": [
					"Anonymity violation",
					"Page limit exceeded",
					"AI tool listed as author",
			...
			},
			{
				...
				"location": {
					...
					"country": "USA",
					"flag": "🇺🇸",
					"venue": "Georgia World Congress Center & International Convention Centre"
				},
				"deadlines": [
					{
						"type": "abstract",
					...
					},
					{
						"type": "event",
						"label": "Sponsor Payment Deadline",
						"date": "2026-11-15T18:59:00+11:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					},
			...
			},
			{
				...
				"deadlines": [
					...
					{
						"type": "supplementary",
						"label": "Supplementary Material Deadline (Round 1)",
						"date": "2025-07-18T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "notification",
						"label": "Round 1 Author Notification",
					...
					{
						"type": "paper",
						"label": "New Paper Registration Deadline (Round 2)",
						"date": "2025-09-12T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "notification",
						"label": "Camera-Ready Deadline (Round 1 Accepted)",
					...
					{
						"type": "paper",
						"label": "Rebuttal and Revision Submission (Round 1 to 2)",
						"date": "2025-09-19T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "paper",
						"label": "Round 2 Paper Submission Deadline",
						"date": "2025-09-19T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "supplementary",
						"label": "Supplementary Material Deadline (Round 2)",
						"date": "2025-09-19T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "paper",
						"label": "AC: Screen Papers Deadline",
					...
					{
						"type": "art",
						"label": "AC: Chase Late Reviewers Start",
						"date": "2025-10-17T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "art",
						"label": "AC: Find Emergency Reviewers Start",
						"date": "2025-10-20T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "event",
						"label": "AC: Chase Late Reviewers End",
					...
					{
						"type": "notification",
						"label": "Final Notification (Round 2)",
						"date": "2025-11-05T23:59:00-12:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "notification",
						"label": "Round 1 Final Author Notification",
					...
					{
						"type": "notification",
						"label": "Round 2 Final Author Notification",
						"date": "2025-11-06T07:59:00+00:00",
						"endDate": null,
						"status": "upcoming",
						"estimated": false
					...
					{
						"type": "notification",
						"label": "Camera-Ready Deadline (Round 2 Accepted)",
					...
					{
						"type": "camera",
						"label": "Camera-Ready Deadline (Round 1 & 2)",
					...
					{
						"type": "paper",
						"label": "Doctoral Consortium Submission",
					...
					{
						"type": "paper",
						"label": "Poster Image and Video Upload Deadline for Main Conference Papers",
				...
				"info": {
					"pageLimit": "8 pages + including figures and tables; additional pages for references allowed",
					"reviewType": "Double-blind",
					"submissionFormat": "PDF",
					"tracks": "Applications, Algorithms",
					"submissionSystem": "OpenReview",
					"authorRegistrationDeadlineForProceedings": "January 17th",
					"paperEvaluationCriteria": "Application papers evaluated on systems-level innovation, novelty of domain, comparative assessment; Algorithm papers evaluated on algorithmic novelty, quantified evaluation.",
					"paperTypes": "application or algorithms papers with different reviewing criteria",
					"specialIssue": "Extended versions of accepted papers will be featured in a special issue of the Machine Vision and Applications (MVA) journal."
				},
				"deskRejectReasons": [
					"Not properly anonymized",
					"Does not use template",
					"Page limit exceeded (8 pages excluding references)",
					"Late submissions",
					"Misconfigured OpenReview accounts",
					"Changes to author lists after deadline",
					"Incomplete or inaccurate conflict information",
					"Author changes after paper registration deadline",
					"Submitting round 1 paper as new in round 2",
					"Missing valid OpenReview profile for authors",
					"Anonymity violation (identifying authors)",
					"Dual or double submission",
					"Not using the WACV template",
					"Page limit exceeded (more than 8 pages excluding references)",
					"Failure to complete assigned timely, quality reviews",
					"Wrong template",
					"Page limit exceeded (8 pages)",
					"Formatting violations",
					"Anonymity violations",
					"Supplementary material guideline violations",
					"Code reveals author identity",
					"Round 1 rejected paper submitted as new Round 2",
					"Incomplete submission",
					"Not meeting required criteria",
					"Substantially same Round 1 paper in Round 2",
					"Rebuttal exceeding one page",
					...
					"ACs not completing timely, quality metareviews",
					"Page limit exceeded",
					"Author names on paper or supplemental",
					"Author of highly irresponsible review",
					"Author of late review",
					"Violation of official policies",
					"Glaring ethics violations",
					"No description of ethical principles",
					"Code submission anonymity violation",
					"Supplementary material guideline violation",
